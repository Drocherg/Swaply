...
import { helpCircle, eye, eyeOff, person, close, arrowBack } from 'ionicons/icons';
...
const handleLogin = () => {
  ...
  if (!usernameError.value && !passwordError.value) {
    ...
    // Redirigir a /InicioLoginAyuda1
    router.push('/Home1');
    // Lógica de inicio de sesión (simulación)
    console.log('Inicio de sesión exitoso:', { username: username.value, password: password.value });
