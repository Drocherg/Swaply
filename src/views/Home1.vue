...
const allItems = ref<Product[]>([
  {
    ...
    description: 'Placa base MSI en excelente estado, perfecta para gaming.'
  },
  {
    id: 2,
    ...
    description: 'Portátil gaming de alta gama con la última tecnología.'
  },
  {
    id: 3,
    ...
    description: 'Silla reclinable cómoda, perfecta para largas sesiones de trabajo o gaming.'
  },
  {
    id: 4,
    ...
    description: 'Silla reclinable negra cómoda, perfecta para largas sesiones de trabajo o gaming.'
  },
  {
    id: 5,
    ...
    description: 'Placa base gaming de alta calidad, ideal para configuraciones potentes.'
  },
  {
    id: 6,
    ...
    description: 'Portátil ASUS ROG Zephyrus G14, potente y ligero.'
  },
  {
    id: 7,
    ...
    description: 'Monitor gaming de 144Hz con una excelente calidad de imagen.'
  },
  {
    id: 8,
  ...
  },
  {
    ...
    description: 'Ratón gaming con alta precisión y respuesta.'
  },
  {
    id: 10,
    ...
    description: 'Auriculares gaming con sonido envolvente y micrófono.'
  }
]);
...
// Function to navigate to product detail (Conver1)
const goToProductDetail = (product: Product) => {
  router.push({ 
    name: 'Conver1', 
    params: { id: product.id.toString() },
    state: { product: JSON.parse(JSON.stringify(product)) }
  });
};
...
// Función para redirigir a MyProducts1
