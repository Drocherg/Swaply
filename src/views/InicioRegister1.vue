      ...
      <div class="splash-container">
          ...
          <div class="content-wrapper">
            ...
            <div class="register-card">
              ...
              <div class="form-group">
                ...
                />
                <div v-if="usernameError" class="error-message">El usuario es obligatorio</div>
              </div>
              ...
              <div class="form-group">
                ...
                <div v-if="passwordError" class="error-message">La contraseña es obligatoria</div>
              </div>

              <ion-button expand="block" class="register-button" @click="handleRegister">
                Registrarse
              </ion-button>
            </div>
          </div>
        ...
        <div v-if="showHelp" class="help-overlay" @click="toggleNextField">
          ...
          <div class="content-wrapper">
            ...
            <div class="register-card">
              <h2 class="register-title opacity-50">Crea tu cuenta:</h2>
              ...
              <ion-button expand="block" class="register-button opacity-50" disabled>
                Registrarse
              </ion-button>
            </div>
          </div>
...
import { helpCircle, eye, eyeOff, close } from 'ionicons/icons';
...
const handleRegister = () => {
  ...
  if (!usernameError.value && !passwordError.value) {
    ...
    console.log('Registro exitoso:', { username: username.value, password: password.value });
